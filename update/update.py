...
#     cursor = conn.cursor()
#     cursor.execute("SELECT surname, initials, institution from researchers;")
...
#     for row in rows:
#         params = {
#             "api_key": "1b63742a7689cc2becb431ca0c7552e25950e5a48a4d3cb3d1040c422dc2ada7",
#             "engine": "google_scholar_profiles",  # profile results search engine
#             "mauthors": (row[0]+" "+row[1]+ " "+ row[2]) 
...
#     c.execute('CREATE TABLE IF NOT EXISTS Citations (author_id TEXT PRIMARY KEY , Name TEXT,Institution TEXT,Citations NUMERIC)')
    
    
    
        
#     c.executemany("INSERT INTO Citations (author_id, Name,Institution,Citations) VALUES(?,?,?,?)", (author_id, name,affiliations,cited_by))
...
#         params = {
#             "api_key": "1b63742a7689cc2becb431ca0c7552e25950e5a48a4d3cb3d1040c422dc2ada7",      # SerpApi API key
...
#     author_results()
#     all_author_articles()
#     save_author_result_to_csv()
#     save_author_articles_to_csv()
#     save_profile_results_to_csv()
